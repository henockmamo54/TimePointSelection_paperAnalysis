...
# Base R plot
plot(kestimated$t, (kestimated$k - kestimated$term1) / kestimated$k, type = "o", lty = 3, col = "red", pch = 16, xlab = "time", ylab = "k - Relative Error", main = paste("k =", kval), lwd = 0.7, xaxt = "n", ylim = c(ymin, ymax))
...
lines(kestimated$t, (kestimated$k - kestimated$term100) / kestimated$k, type = "o", lty = 3, col = "black", pch = 16, lwd = 0.7)

legend("topright", legend = c("n=1", "n=2", "n=3", "n=10"), col = c("red", "blue", "green", "purple", "black"), lty = 3, pch = 16)
