...
data=pd.read_csv("temp_0_025.csv")
...
rect=patches.Rectangle(( min(temp_data['Labeling Duration']) - 0.4, low-0.001),
                        ...
                        high-low +0.001, facecolor="g", alpha=0.2)
...
ax.text(8, low-0.015, "Lower Limit (theo.) = " +r"$0.65 * I_0(0) + 0.35 * I_0^{asmyp}$", ha='center', va='bottom', fontsize=10, color='r')
...
plt.savefig("Figure5_0025.jpeg",dpi=900)
